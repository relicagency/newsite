    ...
    angular.module('app').controller('mobileNavCtrl', function ($scope, mainService) {
        ...
        $scope.exitNav = function () {
            ...
            if (trigger) {
                ...
                tl.to(hamburgerSix, 0.08, { transform: "rotate(0deg)" }, "-=0.08").to(hamburgerFive, 0.08, { transform: "rotate(0deg)" }).to(hamburgerThree, 0.08, { position: "relative", bottom: 0 }).to(hamburgerOne, 0.08, { position: "relative" }).to(hamburgerTwo, 0.08, { position: "relative", top: '0', left: 0, transform: "rotate(0deg)" }).to(hamburgerSix, 0.08, { right: "-100px" }).to(hamburgerFive, 0.08, { right: "-100px" }, "-=0.08").to(hamburgerFour, 0.08, { top: "6px", left: 0, transform: "rotate(0deg)" }).to(mobileNav, 0.15, { right: "-101%", ease: Power2.easeOut });
            }
