    ...
    angular.module('app')
        .controller('homeContentCtrl', function($scope){
            ...
            $scope.swnContentHover = function(num){
                ...
                } else { TweenMax.to(document.getElementById('services-content-' + num), 0.5, {ease: Power2.easeOut, height: "350px"}, 0.25) }
            ...
            $scope.swnContentHoverLeave = function(num){
                ...
                } else { TweenMax.to(document.getElementById('services-content-' + num), 0.25, {ease: Power2.easeOut, height: "300px"}) }            }
